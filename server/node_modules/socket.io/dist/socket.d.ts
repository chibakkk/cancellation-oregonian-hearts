...
export declare class Socket<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap, SocketData = any> extends StrictEventEmitter<ListenEvents, EmitEvents, SocketReservedEventsMap> {
     ...
     * @example
     * io.on("connection", (socket) => {
     *   // the “foo Eevent will be broadcast to all connected clients in the “room-101 Eroom, except this socket
     ...
     * @example
     * io.on("connection", (socket) => {
     *   // the “foo Eevent will be broadcast to all connected clients, except this socket
     ...
     * @example
     * io.on("connection", (socket) => {
     *   // the “foo Eevent will be broadcast to all connected clients on this node, except this socket
